...
| 03 | [`03-terraform-app-tier/`](./03-terraform-app-tier/) | App-tier resources on top of `02`'s VPC — EC2 in the private subnet, ALB, DynamoDB — consumed via `terraform_remote_state`, one cohesive use case rather than a folder per resource |
